...
var p2poolMainNetHardForks = []monero.HardFork{
	{Version: uint8(ShareVersion_V1)},
	// p2pool hardforks at 2023-03-18 21:00 UTC
	{Version: uint8(ShareVersion_V2), Time: 1679173200},
	// Oct 12 2024 20:00:00 GMT+0000
	{Version: uint8(ShareVersion_V3), Time: 1728763200},
}

var p2poolTestNetHardForks = []monero.HardFork{
	{Version: uint8(ShareVersion_V1)},
	// p2pool hardforks at 2023-01-23 21:00 UTC
	{Version: uint8(ShareVersion_V2), Time: 1674507600},
	...
	{Version: uint8(ShareVersion_V3), Time: 1718740800},
}

var p2poolStageNetHardForks = []monero.HardFork{
	//always latest version
	{Version: p2poolMainNetHardForks[len(p2poolMainNetHardForks)-1].Version},
}
...
func (v ShareVersion) Supports(majorVersion uint8) bool {
	...
	return majorVersion >= monero.HardForkMinimumP2PoolSupportedVersion && majorVersion <= monero.HardForkSupportedVersion
}
