...
TEXT ·aes_rounds_internal_avx512(SB),NOSPLIT|NOFRAME,$0-16
	...
	VBROADCASTI32X4 0*16(BX), Z1
	VBROADCASTI32X4 1*16(BX), Z2
	VBROADCASTI32X4 2*16(BX), Z3
	VBROADCASTI32X4 3*16(BX), Z4
	VBROADCASTI32X4 4*16(BX), Z5
	VBROADCASTI32X4 5*16(BX), Z6
	VBROADCASTI32X4 6*16(BX), Z7
	VBROADCASTI32X4 7*16(BX), Z8
	VBROADCASTI32X4 8*16(BX), Z9
	VBROADCASTI32X4 9*16(BX), Z10
