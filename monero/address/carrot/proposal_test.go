...
func TestPaymentProposalV1_CoinbaseOutput(t *testing.T) {
	expectedEnote := CoinbaseEnoteV1{
		OneTimeAddress:  curve25519.PublicKeyBytes(types.MustHashFromString("a3d1d782671a3622bf393fe8116c8df95e9e12776e2970ab1934645f40748343")),
...
func BenchmarkPaymentProposalV1_Output(b *testing.B) {
	...
	firstKeyImage := curve25519.PublicKeyBytes(types.MustHashFromString("a3d1d782671a3622bf393fe8116c8df95e9e12776e2970ab1934645f40748343"))
	prop := &PaymentProposalV1[curve25519.VarTimeOperations]{
		Destination: DestinationV1{
