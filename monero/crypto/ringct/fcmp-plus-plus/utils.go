...
func ProofSize(inputs, layers int) int {
	return MembershipProofSize(inputs, layers) + (inputs * (FCMP_PP_SAL_PROOF_SIZE_V1 + FCMP_PP_INPUT_TUPLE_SIZE_V1))
}

func MembershipProofSize(inputs, layers int) int {
	return membershipProofSize[inputs-1][layers-1]
...
var membershipProofSize = [MaxInputs][MaxLayers]int{
