...
func (bv *BatchVerifier[T]) Verify() bool {
	return (*bulletproofs.InternalBatchVerifier[T])(bv).Verify(curve25519.FromPoint[T](crypto.GeneratorH.Point), curve25519.FromPoint[T](crypto.GeneratorG.Point), bulletproofs.GeneratorPlus)
}
